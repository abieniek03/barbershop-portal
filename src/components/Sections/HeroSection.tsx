...
const HeroSection: FC<IHeroSection> = () => {
	return (
		<section
			id='#home'
			className="bg-center bg-no-repeat bg-[url('https://images.pexels.com/photos/1813272/pexels-photo-1813272.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] bg-gray-700 bg-blend-multiply bg-cover"
		>
